...
from tfnlp.nets.bert.bert_util import * 
from tfnlp.nets.bert import bert_model
from tfnlp.nets.bert import bert_conf
from tfnlp.optimizers import optimizer_factory
...
def model_fn_builder(bert_config, init_checkpoint, learning_rate,
    ...
    def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            train_op = optimizer_factory.create_optimizer(total_loss, learning_rate, num_train_steps, num_warmup_steps, use_tpu)
...
# mask 语言模型损失函数
def get_masked_lm_output(bert_config, input_tensor,
                         output_weights, positions,
...
def main(_):
    ...
    # load conf
    bert_config = bert_conf.BertConfig.from_json_file(FLAGS.bert_config_file)
