...
function fmt_train()
{
    ...
    python ${ROOT_PATH}/app_pretrain/gen_lm_data.py \
        --conf_path=${DATA_PATH} \
        --input_file=${DATA_PATH}/pretrain/train.txt \
        --token_file=${DATA_PATH}/pretrain/dev_tok.txt \
        --tf_file=${DATA_PATH}/pretrain/dev_tfrecord
    return 0
}
...
function train_model()
{
    ...
    #    --block_py ${ROOT_PATH}/tfnlp/blocks/block_lstm \
    #    --block_class BlockLSTM \
    #    --config_dir ${ROOT_PATH}/model/pre_train_elmo_2_lstm/options.json \
    #    --ckpt_file ${ROOT_PATH}/model/pre_train_elmo_2_lstm/2LayerLstm.final \
    #    --outfile_weights ${ROOT_PATH}/model/pre_train_elmo_2_lstm/weights.hdf5
...
function fine_tune_task()
{
    python ${ROOT_PATH}/assemble_net.py \
        ...
        --conf_path ${ROOT_PATH}/task/elmo_emotion/elmo_lstm_emotion_listwise.json
